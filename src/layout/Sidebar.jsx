    ...
    >
      <div className="sidebarHeader">
          <div className="sidebarBrand">
            ...
            <div className="sidebarBrandCopy"><strong>ABP Seguros</strong><span>Portal de gestión</span></div>
          </div>
        <button 
          type="button" 
      ...
      <p className="sidebarEyebrow">MI ESPACIO DE TRABAJO</p>
      <nav className="sidebarNav" aria-label="Módulos de gestión">
        {sections.map((s) => (
          <button
            key={s.id}
            type="button"
        ...
        {canManageUsers && (
          ...
          >
            ...
            <span className="sidebarNavLabel">Usuarios</span>
          </button>
        )}
      </nav>
    </aside>
